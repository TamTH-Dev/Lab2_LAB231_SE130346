<%-- 
    Document   : payment-review
    Created on : Feb 28, 2020, 10:31:14 PM
    Author     : hoang
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="review-title">Please Review Before Paying</h1>
            <c:url var="executePayment" value="PaymentExecuting">
                <c:param name="paymentId" value="${param.paymentId}" />
                <c:param name="PayerID" value="${param.PayerID}" />
            </c:url>
            <form class="review-form" action="${executePayment}" method="POST">
